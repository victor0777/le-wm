#!/bin/bash
# Track 2: Token-conditioned training — sequential to avoid HDF5 deadlock
...
EPOCHS=15
COMMON="data=rtb_occany wandb.enabled=False trainer.devices=1 trainer.max_epochs=$EPOCHS num_workers=4 loader.prefetch_factor=2"

echo "=== Track 2: Token-conditioned training (sequential) ==="

echo ""
echo "--- V1: Livlab 3 -> 8014dd (resume) ---"
